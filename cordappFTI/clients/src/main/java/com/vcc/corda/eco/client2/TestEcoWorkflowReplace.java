...
public class TestEcoWorkflowReplace extends TestEcoWorkflow {
    ...
    public static void issue() throws ExecutionException, InterruptedException {
        ...
        CordaRPCConnection connection = new TestEcoWorkflowReplace().getConnection( "localhost:10005", "user1" , "test" );
        final CordaRPCOps proxy = connection.getProxy();
        try {

            command = new EcoContract.Commands.Replace();
